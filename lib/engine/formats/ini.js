...
const parseValue = (value) => {
  ...
  if (_.isString(value)) {
    ...
    // Split by commas NOT followed by spaces
    // See: http://stackoverflow.com/a/24293775/1641422
    const parts = _.split(value, /,(?! )/g);

    if (_.size(parts) > 1) {
      return _.map(parts, parseValue);
    }
  }
