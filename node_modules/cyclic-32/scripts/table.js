...
var int32a = Int32Array.from( TABLE )
var int32b = Buffer.alloc( int32a.length * 4 )

var offset = 0

for( var i = 0; i < int32a.length; i++ ) {
  int32b.writeInt32BE( int32a[i], offset )
  offset += 4
}
...
process.stdout.write( 'new Int32Array([\n' )
while( i < int32a.length ) {
  var hex = int32b.toString( 'hex', offset + (i*4), offset + (i*4) + 4 )
...
// console.log( int32a.length, int32b.length )
// console.log( int32a )
